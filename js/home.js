// let img1 = document.getElementById("metal-1");
// let box = document.querySelector(".box");
// let rep = true;
// img1.onclick = function tryone() {
//   if (rep === true) {
//     box.style.width = "100%";
...
// there are still some transition bugs are left...
let curPage = 1;
let scrolling = true;
