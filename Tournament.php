...
echo '
  ...
  <?php 
    foreach($rows5 as $rowss5) { 
      echo '
<h2 class="h2 section-title">'.$rowss5['Name'].'</h2>
...
<section class="game-section">
  ...
  foreach($rows6 as $rowss6) { 
    if($rowss6['game_code'] ==  $rowss5['Code']) {
          echo '<a href="MAINTOUR.php?do=tour&Code='.$rowss6['Code'].'">' ;
      echo '<div class="item active" style="background-image: url('.$rowss6['logo'].');">' ;
      echo '<div class="item-desc">' ;
      echo '<h3>'.$rowss6['Name'].'</h3>' ;
      echo '<br>' ;
      echo '<h5> ' .$rowss6['Description']. '</h5>';
      echo '<p></p>';
      echo '</div>' ;
      echo '</div>' ;
      echo '</a>' ;
